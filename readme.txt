=== Cart66 to WooCommerce Migration ===
Contributors: LitExtension
Donate link: 
Tags: Cart66 to woocommerce, Cart66 to woocommerce migration, migrate Cart66 to woocommerce  
...
This plugin allows you to migrate your products, orders, customers, passwords and other data from Cart66 to WooCommerce automatically.

== Description ==
This plugin allows you to migrate your products, categories, orders, customers, passwords and other data from Cart66 to WooCommerce automatically. 
...
 
= ADDITIONAL FEATURES =
* No Downtime: Data is migrated with no downtime for your current Cart66 store
...
* Migrate Recent Data: You have just finished a full migration, after that Cart66 is still live and continue getting new data, and you want to get your WooCommerce updated with the new data, this feature to avoid starting over again.
...
* Data Security: Direct data transfer from Cart66 to WooCommerce, NO third party involved
...
3. Go to the Plugins -> Cart66 to WooCommerce Migration


== Documentation and Support ==
Please visit [LitExtension FAQ section](http://litextension.com/woocommerce-migration-tool/Cart66-to-woocommerce.html) if you have any questions about migration to WooCommerce.
